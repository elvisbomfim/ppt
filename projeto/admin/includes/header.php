        ...
        <div class="navbar-header">
            <a class="navbar-brand" href="index.html">
                ...
                <b>
                    ...
                    <!-- Dark Logo icon -->
                    <img src="<?=BASE?>admin/assets/images/logo-principe-da-torta-icone.png" alt="homepage" class="dark-logo" />
                ...
                <span>
                    <!-- dark Logo text -->
                    <img src="<?=BASE?>admin/assets/images/logo-principe-da-torta.png" alt="homepage" class="dark-logo" />
                </span>
            </a>
        </div>
        <!-- ============================================================== -->
