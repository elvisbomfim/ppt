...
switch ($Action):
    ...
    case 'manager':
        ...
        $date_criacao = date('Y-m-d H:i:s', strtotime($pedido_data_criacao));
        $datetimecriacao = new DateTime($date_criacao);

        $date_retirada = date('Y-m-d H:i:s', strtotime($pedido_data_retirada));
        ...
        $DADOS['pedido_data_criacao'] = $datetimecriacao->format('Y-m-d\TH:i:s');
        $DADOS['pedido_data_retirada'] = $datetimeretirada->format('Y-m-d\TH:i:s');
...
//        $jSON["type"] = "criado";
    ...
    case 'update':
        ...
        /*        if (empty($POST['cliente_id'])):
          ...
          $Update = clone $Update;
          $Update->ExeUpdate('pedidos_refrigerante', $pedido_refrigerante);
          endif;
