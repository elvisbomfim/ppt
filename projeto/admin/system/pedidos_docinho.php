...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="bgc-white bd bdrs-3 p-20 mB-20">
            <table data-pedido-nome="doce" data-callback_action="refresh" class="table tablePPT table-striped table-bordered" cellspacing="0" width="100%">
                        <thead>
                            <tr>
