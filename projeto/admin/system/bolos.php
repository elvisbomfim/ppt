<div class="row page-titles">
    ...
    <div class="col-md-6 col-8 align-self-center">
        <h3 class="text-themecolor m-b-0 m-t-0">Bolos</h3>
        <ol class="breadcrumb">
            <li class="breadcrumb-item"><a href="javascript:void(0)">Painel</a></li>
            <li class="breadcrumb-item active">Gerenciamento de Bolos</li>
        </ol>
    </div>
    <div class="col-md-6 col-4 align-self-center">
    <h4 class="c-grey-900 mB-20"> <button class="btn btn-success j_action pull-right" data-callback="categorias_bolos" data-callback_action="manager"><i class="fa fa-plus"></i> Cadastrar novo</button></h4>
...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="bgc-white bd bdrs-3 p-20 mB-20">
            <table id="bolosTable" class="table tablePPT table-striped table-bordered" cellspacing="0" width="100%">
                <thead>
                    <tr>
                        <th>Bolos</th>
                        <th>Preço</th>
...
<!-- Modal -->
<div class="modal fade" id="bolosModal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
