                    ...
                    <div class="mT-30">
                        ...
                        <form action="" method="post">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="categoria_bolo_preco_kg" class="form-control" id="categoria_bolo_preco_kg"  >
                            </div>
                            <div class="form-group">
                                <label>Preço kit festa:</label>
                                <input type="text" name="categoria_bolo_kit_festa" class="form-control" id="categoria_bolo_kit_festa"  >
                            </div>
